<#if !(.globals.g3dmath_glsl??)>
<#global g3dmath_glsl=1>
...
<#assign gentypes = ["int", "ivec2", "ivec3", "ivec4", "float", "vec2", "vec3", "vec4"]>
<#list gentypes as gentype>
...
<#assign gentypes = ["float", "vec2", "vec3", "vec4"]>
<#list gentypes as gentype>
    /**
...
<#assign gentypes = ["vec2", "vec3", "vec4"]>
<#list gentypes as gentype>
...
vec2 mipMapLevel(in vec2 texture_coordinate, in vec2 textureSize) {
