...
/**
 ...
 \edited  2014-04-04
 */
<#if !(.globals.UniversalSurface_vertex_h??)>
<#global UniversalSurface_vertex_h=1>
<#include "../compatibility.glsl.ftl">

<@expect name="HAS_VERTEX_COLORS" msg=""/>
...
<#include "UniversalSurface_vertexHelpers.glsl.ftl">
