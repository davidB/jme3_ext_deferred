...
class Pass4Shade {
	...
	public Pass4Shade(Geometry finalQuad, ViewPort vp, RenderManager rm, AssetManager assetManager, GBuffer gbuffer, Texture2D matBuffer, Texture aoBuffer, Texture lBuffer){
